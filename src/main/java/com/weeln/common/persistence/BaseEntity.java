...
public abstract class BaseEntity<T> implements Serializable {
	...
	public static final String USER_DEFAULT_PASSWD = "123456";
	public static final String USER_DEFUALT_ENCRYPTED_PASSWD = SystemService.entryptPassword(USER_DEFAULT_PASSWD);
