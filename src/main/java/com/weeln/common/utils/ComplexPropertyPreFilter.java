...
public class ComplexPropertyPreFilter implements PropertyPreFilter {
    ...
    public ComplexPropertyPreFilter(Map<Class<?>, String[]> includes,boolean isNotCheck) {
        super();
        this.includes = includes;
        this.isNotCheck = isNotCheck;
    }
	...
	public void setNotCheck(boolean isNotCheck) {
		this.isNotCheck = isNotCheck;
	}
