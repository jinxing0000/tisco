...
import com.weeln.common.annotation.FieldName;
import com.weeln.common.config.Global;
import com.weeln.common.utils.Encodes;
import com.weeln.common.utils.ObjectUtils;
...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	public static final String[] PD_CG = new String[]{"cglc","purchase"};
	...
	public static final String[] PD_OFFICIAL_SEAL = new String[]{"official_seal_apply", "tb_official_seal_apply"};
	public static final String[] PD_BUSINESS_TRIP = new String[]{"business_trip_audit", "tb_business_trip"};
	public static final String[] PD_VEHICLE_USE = new String[]{"vehicleUserProcess", "tb_vehicle"};
	public static final String[] PD_DIPATCH_FILE = new String[]{"docDispatchFlow", "tb_dispatch_file"};
	public static final String[] PD_IN_BASKET = new String[]{"in_basket_process", "tb_in_basket"};
//	/**
//	 * 流程定义Map（自动初始化）
//	 */
