...
import com.weeln.modules.sys.service.AreaService;
...
//		}
	...
	@ResponseBody()
	@RequestMapping(value = "/sub/{parentId}")
	public List<Area> getSubArea(@PathVariable("parentId")String parentId) {
		System.out.println("==== parentId = " + parentId);
		List<Area> cities = areaService.findSubList(parentId);
