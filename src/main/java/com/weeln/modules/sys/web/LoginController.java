...
import com.weeln.common.servlet.ValidateCodeServlet;
import com.weeln.common.utils.CacheUtils;
import com.weeln.common.utils.CookieUtils;
...
import com.weeln.modules.iim.entity.MailPage;
import com.weeln.modules.iim.service.MailBoxService;
import com.weeln.modules.oa.entity.OaNotify;
import com.weeln.modules.oa.service.OaNotifyService;
import com.weeln.modules.sys.entity.User;
import com.weeln.modules.sys.security.FormAuthenticationFilter;
...
//		try {
//			byte[] bytes = com.weeln.common.utils.FileUtils.readFileToByteArray(
//					com.weeln.common.utils.FileUtils.getFile("c:\\sxt.dmp"));
...
//		System.out.println("==========================b");
	 ...
	 * @return
	 */
	private List<Article> getArticlesByStatus(String status) {
	...
	public String home(HttpServletRequest request, HttpServletResponse response, Model model) throws IOException {
		// 获取已发布的新闻列表
		List<Article> issuedArticles = getArticlesByStatus(Article.ARTICLE_ISSUE_STATUS_4);
		model.addAttribute("issuedArticleNum", issuedArticles.size());
		
		// 获取待审核新闻列表
		List<Article> inAuditingArticles = getArticlesByStatus(Article.ARTICLE_ISSUE_STATUS_1);
		model.addAttribute("inAuditingArticleNum", inAuditingArticles.size());
		
		// 获取APP端注册用户数
		User user = new User();
		user.setRegWay(User.USER_REG_WAY_APP);
		List<User> appUsers = systemService.findUser(user);
		model.addAttribute("appUserNum", appUsers.size());
