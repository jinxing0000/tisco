<%@ page contentType="text/html;charset=UTF-8" %><meta http-equiv="Content-Type" content="text/html;charset=utf-8" /><meta name="author" content="http://www.weeln.org/"/>
...
<script src="${ctxStatic }/jqueryImage/js/jquery.imageMaps.min.js" type="text/javascript"></script>
