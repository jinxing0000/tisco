...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
        	location = '${ctx}/oa/dispatchFile/process/?pageNo='+n+'&pageSize='+s;
        }
	</script>
</head>
<body class="gray-bg">
...
<%-- 	<!--查询条件-->
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm"  action="${ctx}/oa/dispatchFile/process/" method="post" class="form-inline">
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<tbody>
			<c:forEach items="${page.list}" var="object">
				...
				<c:if test="${process.category == '7' or process.category == '8'}">
				<tr>
					...
					<td>
						<a href="${ctx}/act/task/form?procDefId=${process.id}">新建申请</a>
					</td>
				</tr>
				</c:if>
			</c:forEach>
