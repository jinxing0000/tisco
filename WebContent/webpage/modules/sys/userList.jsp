...
<%-- 			<span>归属公司：</span>
			...
			<span style="margin-left:30px;">登&nbsp;&nbsp;录&nbsp;&nbsp;名：</span>
...
<%-- 				<td>${user.company.name}</td>
				...
				<td>
					...
					<shiro:hasPermission name="sys:user:reset">
						<a href="${ctx}/sys/user/reset?id=${user.id}" onclick="return confirmx('确认要重置该用户密码吗？', this.href)" class="btn btn-warning btn-xs"><i class="fa fa-trash"></i>重置密码</a>
					</shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
