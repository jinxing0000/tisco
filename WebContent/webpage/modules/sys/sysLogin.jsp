...
<html>
	...
	<head>
		...
		<link href="${ctxStatic}/common/weeln.css" type="text/css" rel="stylesheet" />
		<script src="${ctxStatic}/common/weeln.js" type="text/javascript"></script>
								...
								<div id="login-box" class="login-box visible widget-box no-border bound">
									<div class="widget-body bound">
										<div class="widget-main bound">
											<div class="center">
<%-- 												<img src="${ctxStatic }/common/login/images/brand.png" >
 --%>											</div>
											...
											<form id="loginForm" class="form-signin" action="${ctx}/login" method="post">
												<fieldset>
													...
													<div class="clearfix">
														...
														<label class="inline" style="margin-left:170px;color:#007aff;font-size:13px;">
															<a href="#" data-target="#forgot-box" class="">
																忘记密码?
															</a>
														</label>
													</div>
													...
													<div class="clearfix">
														<button type="submit" style="width:100%;" class="pull-right btn btn-sm btn-primary">
															<span class="bigger-120">登&nbsp;&nbsp;录</span>
														</button>	
													</div>
							...
							<!-- <div class="center" style="margin-top:20px;font-size:14px;font-weight:bold;">
								<font color="white">
									Copyright <span style="font-size: 22px;position: relative;top:4px;">&copy;</span> 太原钢铁（集团）有限公司
								</font>
							</div> -->
